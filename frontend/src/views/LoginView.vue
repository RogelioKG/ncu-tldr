...
const resendButtonLabel = computed(() => {
  ...
  if (countdown.value > 0)
    return `我沒有收到驗證信，重發給我嗚嗚嗚... (${countdown.value})`
  return '我沒有收到驗證信，重發給我嗚嗚嗚...'
})
...
.unverified-panel__icon {
  font-size: 3rem;
  line-height: 1;
}

.unverified-panel__desc {
  font-size: var(--font-size-sm);
  color: var(--color-text-secondary);
  line-height: 1.6;
}

.unverified-panel__btn {
  margin-top: var(--spacing-sm);
}
